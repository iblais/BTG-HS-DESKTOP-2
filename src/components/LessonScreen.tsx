    ...
    <div className="w-full space-y-6 pb-6 md:pb-0">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-center">
          <div className="text-white font-bold">{t('courses.week')} {weekNumber}</div>
      ...
      <GlassCard className="p-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h4 className="text-amber-400 font-bold text-sm">{t('common.resources')}</h4>
        </div>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          {hasActivity && activitySubmitted && (
            <div className="ml-auto flex items-center gap-2 text-[#50D890]">
              <CheckCircle size={18} />
              <span className="text-sm font-medium">{t('common.submitted')}</span>
            </div>
          )}
        </div>
      ...
      <div className="flex gap-3">
        ...
        >
          {!canProceed ? (
            t('courses.completeActivity')
          ) : isLastSection ? (
            t('courses.completeLesson')
          ) : (
            t('courses.nextSection')
          )}
        </Button3D>
      </div>
    </div>
