        ...
        <div className="space-y-6">
                    ...
                    <div className="mt-3">
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          className="flex-1 h-2 bg-white/10 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#14D9C4]"
                        />
                        <input
                          type="number"
                          min="0"
                          ...
                          className="w-16 px-2 py-1 bg-white/[0.05] border border-white/[0.1] rounded-lg text-white text-center focus:outline-none focus:border-[#14D9C4]"
                        />
                      </div>
          ...
          <GlassCard className="p-6">
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-white/[0.05] border border-white/[0.1] rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-[#14D9C4] resize-none"
            />
