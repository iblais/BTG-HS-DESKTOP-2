        ...
        <GlassCard className="p-5">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-[#14D9C4]/20 flex items-center justify-center">
              <BookOpen className="w-6 h-6 text-[#14D9C4]" />
            </div>
            <div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white/[0.05] border border-white/[0.1] rounded-lg text-white placeholder-white/30 focus:outline-none focus:border-[#14D9C4]"
          />
        </div>
        ...
        <select
          ...
          className="px-4 py-2.5 bg-white/[0.05] border border-white/[0.1] rounded-lg text-white focus:outline-none focus:border-[#14D9C4] appearance-none cursor-pointer"
        >
          <option value="" className="bg-[#0D0F12]">All Categories</option>
          {categories.map(cat => (
            <option key={cat} value={cat} className="bg-[#0D0F12]">{cat}</option>
          ))}
        </select>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        isCompleted ? 'bg-[#50D890]/20' : 'bg-[#14D9C4]/20'
                      }`}>
                        {isCompleted ? (
                      ...
                      {standards.map((standard, index) => (
                        ...
                        >
                          <div className="flex items-start gap-3">
                            <span className="px-2 py-1 rounded bg-[#14D9C4]/20 text-[#14D9C4] text-xs font-mono whitespace-nowrap">
      ...
      {filteredStandards.length === 0 && (
        <div className="text-center py-12">
          ...
          <button
            ...
            className="mt-2 text-[#14D9C4] text-sm hover:underline"
          >
            Clear filters
          </button>
        </div>
